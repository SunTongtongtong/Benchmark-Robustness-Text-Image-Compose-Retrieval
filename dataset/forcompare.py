...
class CIRRDataset_reason(BaseDataset):
    ...
    def __init__(self, reasoning_caption_file,split, vocab, transform, what_elements='triplet', load_image_feature=0, ** kw):
        ...
        # shitong change for our dataset
        # self.image_name2path = self.load_file('./img_path.json')
        self.image_name2path = self.load_file('./reasoning_captions/image_split/img_path_merged_clean.json')
