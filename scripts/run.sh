...
MODELS="IMAGEONLY" # choose: ARTEMIS / TIRG / MAAF / CIRPLANT / CLIP4CIR / FASHIONVIL TEXTONLY IMAGEONLY MAAF CLIP4CIR
...
do
    ...
    do
        ...
        do
            ...
            corruption_level="${REASON_FILE}_corruption_level_${IMG_CORRUPT_LEVEL}_lstm512_resnet50"
