...
# DATASET = "$2"
MODELS="instructBLIP" # choose: ARTEMIS / TIRG / MAAF / CIRPLANT / CLIP4CIR / FASHIONVIL /instructBLIP / BLIP4CIR
...
do
    ...
    do
        ...
        do
            ...
            corruption_level="${IMG_CORRUPT}_corruption_level_${IMG_CORRUPT_LEVEL}_carmathen_onlytag"
